...
<acme:form> 
	<acme:form-textbox code="inventor.invention.form.label.ticker" path="ticker" readonly="${!draftMode && _command != 'create'}"/>
	<acme:form-textbox code="inventor.invention.form.label.name" path="name" readonly="${!draftMode  && _command != 'create'}"/>
	<acme:form-textarea code="inventor.invention.form.label.description" path="description" readonly="${!draftMode  && _command != 'create'}"/>
	<acme:form-moment code="inventor.invention.form.label.startMoment" path="startMoment" readonly="${!draftMode  && _command != 'create'}"/>
